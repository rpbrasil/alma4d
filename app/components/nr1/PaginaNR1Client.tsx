    ...
    <>
      ...
      <main className="bg-background text-foreground">
        ...
        <section className="px-6 py-14 bg-linear-to-b from-brand-highlight/50 to-brand text-white">
          <div className="max-w-6xl mx-auto text-center">
            ...
            <p className="mt-6 text-lg text-white/90 max-w-3xl mx-auto">
              ...
              técnicos válidos para fiscalização, GRO e PGR — segurança jurídica
              e conformidade LGPD.
            </p>
        ...
        <section className="px-6 py-16 bg-surface-muted">
          <div className="max-w-6xl mx-auto text-center">
            <h2 className="text-2xl font-extrabold text-brand mx-auto">
              Como implementar o mapeamento de riscos psicossociais na NR‑1 com
              COPSOQ II BR
            </h2>
        ...
        {/* ================= PARA QUEM ================= */}
        <section className="px-6 py-10 bg-surface">
          <div className="max-w-6xl mx-auto">
            <h2 className="text-2xl font-extrabold text-brand text-center">
              Escolha seu acesso
            </h2>
        ...
        <details className="max-w-3xl mx-auto mt-6 mb-6 px-4 text-left">
          ...
          <div className="mt-4 text-slate-600">
            ...
            <p className="mt-4 text-slate-600">
              A NR‑1 exige que todas as empresas identifiquem, avaliem e
              controlem os riscos psicossociais dentro do Programa de
              Gerenciamento de Riscos (PGR). Esses riscos incluem fatores como
              estresse ocupacional, sobrecarga de trabalho, metas abusivas,
              assédio moral e falhas na organização do trabalho, que podem
              impactar diretamente a saúde mental e a produtividade dos
              colaboradores.
            </p>

            <p className="mt-4 text-slate-600">
              Para estar em conformidade com a NR‑1, não basta aplicar
              questionários simples ou ações isoladas de bem-estar. A norma
              exige uma abordagem estruturada e documentada, incluindo a
              utilização de metodologias reconhecidas, a geração de um
              inventário de riscos atualizado e a definição de um plano de ação
              com responsáveis, prazos e acompanhamento contínuo.
            </p>

            <p className="mt-4 text-slate-600">
              Ferramentas validadas cientificamente, como o COPSOQ II BR,
              permitem transformar fatores subjetivos do ambiente de trabalho em
              dados objetivos, garantindo maior segurança jurídica e evidência
              técnica para auditorias e fiscalizações.
            </p>
            ...
            <p className="mt-4 text-slate-600">
              ...
              expostas a autuações, passivos trabalhistas e riscos
              reputacionais. Por isso, o uso de soluções digitais com coleta
              estruturada, dashboards e relatórios técnicos automatizados
              tornou-se a forma mais eficiente e segura de atender à NR‑1.
            </p>
            ...
            <p className="mt-6 text-slate-700 font-medium">
              ...
              ser opcional e passou a ser uma exigência estratégica para
        ...
        <Script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "@type": "Service",
              name: "Mapeamento de Riscos Psicossociais NR-1",
              description:
                "Avaliação com COPSOQ II BR e geração de relatório técnico para PGR",
              areaServed: "BR",
              provider: {
                "@type": "Organization",
                name: "alma4D",
